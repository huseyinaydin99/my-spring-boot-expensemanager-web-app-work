...
! function(a) {
    ...
    a.extend(a.expr.pseudos || a.expr[":"], {
        ...
        messages: {
            ...
            equalTo: "Lütfen aynı olan değerden giriniz.",
            maxlength: a.validator.format("Lütfen {0} karakterden fazla girmeyin."),
            minlength: a.validator.format("Lütfen {0} karakterden az girmeyin."),
            rangelength: a.validator.format("Lütfen {0} ila {1} aralığında bir değer giriniz."),
            range: a.validator.format("Lütfen {0} ila {1} aralığında bir değer giriniz."),
            max: a.validator.format("Lütfen {0}'a eşit yada küçük bir değer giriniz."),
            min: a.validator.format("Lütfen {0}'a eşit yada küçük bir değer giriniz."),
            step: a.validator.format("Lütfen {0}'ın çarpımı bir değer giriniz.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
